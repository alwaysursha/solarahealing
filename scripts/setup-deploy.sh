...
echo "  RESEND_API_KEY"
echo "  EMAIL_FROM (e.g. Soulara Healing Academy <hello@soularahealing.com>)"
echo "  EMAIL_ADMIN_TO (e.g. soularahealer@gmail.com)"
echo
...
echo "  pnpm exec wrangler secret put RESEND_API_KEY"
echo "  pnpm exec wrangler secret put EMAIL_FROM"
echo "  pnpm exec wrangler secret put EMAIL_ADMIN_TO"
echo
echo "Local deploy:"
