  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] grid min-h-[28rem] lg:min-h-[32rem] lg:grid-cols-12 lg:items-center">
        <motion.div
          className="flex flex-col justify-center px-5 py-16 sm:px-8 md:px-10 md:py-20 lg:col-span-5 lg:px-12 xl:px-14 xl:py-24"
        ...
        <motion.div
          className="relative min-h-[22rem] lg:col-span-7 lg:min-h-[32rem]"
